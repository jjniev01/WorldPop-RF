...
##  For UGA:
#intermediate_prj = "PROJCS['WGS_1984_UTM_Zone_36N',GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Transverse_Mercator'],PARAMETER['False_Easting',500000.0],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',39.0],PARAMETER['Scale_Factor',0.9996],PARAMETER['Latitude_Of_Origin',0.0],UNIT['Meter',1.0]]"
##  For NAM, modified to be in middle of UTM 33 and 34, central meridian set to 18:
#intermediate_prj = "PROJCS['WGS_1984_UTM_Zone_33.5S',GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Transverse_Mercator'],PARAMETER['False_Easting',500000.0],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',18.0],PARAMETER['Scale_Factor',0.9996],PARAMETER['Latitude_Of_Origin',0.0],UNIT['Meter',1.0]]"
##  For THA, modified to be in the middle of UTM 46N and 47N, central meridian set to 96.0:
#intermediate_prj =  "PROJCS['WGS_1984_UTM_Zone_46.5N',GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Transverse_Mercator'],PARAMETER['False_Easting',500000.0],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',96.0],PARAMETER['Scale_Factor',0.9996],PARAMETER['Latitude_Of_Origin',0.0],UNIT['Meter',1.0]]"
##  For MMR, modified to be in the middle of UTM 46N and 47N, central meridian set to 96.0:
#intermediate_prj =  "PROJCS['WGS_1984_UTM_Zone_46.5N',GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Transverse_Mercator'],PARAMETER['False_Easting',500000.0],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',96.0],PARAMETER['Scale_Factor',0.9996],PARAMETER['Latitude_Of_Origin',0.0],UNIT['Meter',1.0]]"
##      For CHN
#intermediate_prj = 'PROJCS["Asia_Lambert_Conformal_Conic",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Lambert_Conformal_Conic"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",105.0],PARAMETER["Standard_Parallel_1",30.0],PARAMETER["Standard_Parallel_2",62.0],PARAMETER["Latitude_Of_Origin",0.0],UNIT["Meter",1.0],AUTHORITY["ESRI",102012]]'
##  For MEX:
intermediate_prj = "PROJCS['WGS_1984_UTM_Zone_13.5N',GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Transverse_Mercator'],PARAMETER['False_Easting',500000.0],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',-102.0],PARAMETER['Scale_Factor',0.9996],PARAMETER['Latitude_Of_Origin',0.0],UNIT['Meter',1.0]]"
##  For NPL:
#intermediate_prj = "PROJCS['WGS_1984_UTM_Zone_44.5N',GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Transverse_Mercator'],PARAMETER['False_Easting',500000.0],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',84.0],PARAMETER['Scale_Factor',0.9996],PARAMETER['Latitude_Of_Origin',0.0],UNIT['Meter',1.0]]"
##  For TZA:
#intermediate_prj = "PROJCS['WGS_1984_UTM_Zone_36.5S',GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Transverse_Mercator'],PARAMETER['False_Easting',500000.0],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',36.0],PARAMETER['Scale_Factor',0.9996],PARAMETER['Latitude_Of_Origin',0.0],UNIT['Meter',1.0]]"
...
if use_UGM:
    Cities_path = data_path + country + "/! Cities/"
    Costtt_path = data_path + country + "/Costtt/"
Population_path = data_path + "/Defaults/Population/"
Protected_path = data_path + "/Defaults/Protected/"
Slope_path = data_path + "/Defaults/Slope/"
LandCover_path = data_path + country + "/LandCover/"
...
def DTE(tiffile, outputpath):
    print("\tPolygonizing...")
    ##  Calculate the DTE  ##
    ##  If there are none of the class, i.e. an empty feature set, break
    if tiffile.maximum < 1:
        print("No Observations of this class.\n\tCreating empty dte raster...")
        null_dte_bool = arcpy.CopyRaster_management(tiffile, outputpath, "DEFAULTS", "", "-999", "NONE", "NONE", "32_BIT_FLOAT")
        null_dte = SetNull(null_dte_bool, -9999)
        null_dte = None
        return None
    else:
        ##    Raster to Polygon:
        arcpy.RasterToPolygon_conversion(tiffile,tmp_path+"_"+lc+"_polyras.shp","NO_SIMPLIFY","VALUE")
        polyras = tmp_path+"_"+lc+"_polyras.shp"
        ##    Convert the polygon to a feature layer:
        polyfeat = arcpy.MakeFeatureLayer_management(polyras, "polyras")

        print("\tLinizing...")
        ##    Polygon to Line:
        arcpy.PolygonToLine_management(polyfeat, tmp_path+"_"+lc+"_polyline.shp", "IGNORE_NEIGHBORS")
        polyline = tmp_path+"_"+lc+"_polyline.shp"

        print("\tCalculating Distance...")
        ##    Distance to Line:
        output = tmp_path+"_"+lc+"_dst_tmp.tif"
        ...
        lcbinary = tiffile
        dteRas = arcpy.sa.Con(lcbinary == 1,-1,0) * dstras + arcpy.sa.Con(lcbinary == 0,1,0)*dstras
        dteRas = arcpy.CopyRaster_management(dteRas, outputpath, "DEFAULTS", "", "-999", "NONE", "NONE", "32_BIT_FLOAT")
        dteRas = arcpy.BuildPyramids_management(dteRas)
        dteRas = None
...
##  Create distance-to raster:
        if dataset_folder == "Urban":
            print("Distance to Edge:  " + dataset_folder)
            ##  Create a 0 1 binary:
            tmpras = arcpy.Raster(data_path + country + "/" + dataset_folder + "/Derived/" + dataset_name + "_cls.tif")
            out_path = data_path + country + "/" + dataset_folder + "/Derived/" + dataset_name + "_dte.tif"
            DTE(tmpras, out_path)
...
if use_UGM:
        ##  Project city points data:
        dataset_folder = "! Cities"
        print("PROCESSING:  " + dataset_folder)
        ...
        if dataset_path:
                ...
                print("ERROR:  No city points found!")
                exit()

        in_path = tmp_path + "/" + dataset_name

        output_name = "cities_prj.shp"
        tmp_path = ensure_dir(data_path + country + "/" + dataset_folder + "/Derived")
        out_path = tmp_path + "/" + output_name
...
##  Process distance-to-EDGE rasters for landcovers of interest:
for lc in ['011', '040', '130', '140', '150', '160', '190', '200', '210', '230', '240', '250', 'BLT']:
    print("Distance to Edge:  " + lc)
    out_path = landcover_path[:-4] + "_dte" + lc + ".tif"
...
#####   BEGIN: Data Preprocessing for UGM specific datasets
if (use_UGM == 1):
        lc = "BLT"

        ####  Proportion of urban pixels within a .15km, 1km, and 5km buffer:
        print("Proportion:  " + lc)
        lcRas = Raster(landcover_path[:-4] + "_cls" + lc + ".tif")
        out_path = landcover_path[:-4] + "_prp150" + lc + ".tif"

        if not os.path.isfile(out_path) or not skip_existing:
            outRas = arcpy.sa.FocalStatistics(lcRas,NbrCircle(1,"CELL"),"MEAN","DATA")
            outRas.save(out_path)
            outRas = None

        out_path = landcover_path[:-4] + "_prp1000" + lc + ".tif"
        if not os.path.isfile(out_path) or not skip_existing:
            outRas = arcpy.sa.FocalStatistics(lcRas,NbrCircle(10,"CELL"),"MEAN","DATA")
            outRas.save(out_path)
            outRas = None

        out_path = landcover_path[:-4] + "_prp5000" + lc + ".tif"
        if not os.path.isfile(out_path) or not skip_existing:
            outRas = arcpy.sa.FocalStatistics(lcRas,NbrCircle(50,"CELL"),"MEAN","DATA")
            outRas.save(out_path)
            outRas = None

        ####  Calculate the cost to the Central Business District (CBD):
        if ("Costtt" in dataset_folders):
            dataset_folders.remove("Costtt")

            ##  Reproject and clip our cost surface to match our landcover:
            dataset_folder = "Costtt"
            print("PROCESSING:  " + dataset_folder)
            ...
            if dataset_name == "":
                if region == "C":
                        dataset_name = "costtt_c_v2.tif"
                if region == "N":
                        dataset_name = "costtt_n_v2.tif"
                if region == "W":
                        dataset_name = "costtt_w_v2.tif"
                if region == "S":
                        dataset_name = "costtt_s_v2.tif"
                in_path = Costtt_path + dataset_name
            else:
                in_path = data_path + country + "/" + dataset_folder + "/" + dataset_name
            ...
            mosaic_name = "costtt_mos.tif"
            tmp_path = ensure_dir(data_path + country + "/" + dataset_folder + "/Derived")
            mosaic_path = tmp_path + "/" + mosaic_name
            output_name = "costtt_prj.tif"    
            out_path = tmp_path + "/" + output_name
            ...
            if not os.path.isfile(out_path) or not skip_existing:
                ...
                arcpy.Clip_management(in_path,"#",mosaic_path,landcover_path,"#","NONE")
                print(" FINISHED: Mosaic...")
            ...
            output_name = "costtt.tif"
            tmp_path = ensure_dir(data_path + country + "/" + dataset_folder + "/Derived")
            out_path = tmp_path + "/" + output_name

            if not os.path.isfile(out_path) or not skip_existing:
                in_source_data = data_path + country + "/! Cities/Derived/cities_prj.shp"
                in_cost_raster = tmp_path + "/costtt_prj.tif"
                outRas = arcpy.sa.CostDistance(in_source_data, in_cost_raster)
                outRas.save(out_path)
                #outRas = None
